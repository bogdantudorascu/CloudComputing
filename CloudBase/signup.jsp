<jsp:include page="components/header.jsp" >
  <jsp:param name="title" value="CloudBase SignUp Page" />
 </jsp:include>
...
<% } %>
   ...
   <div class="container">
	 ...
	 <div class="form-group" >
		...
		<input type="text" name="username" class="form-control" id="exampleUsername1" aria-describedby="emailHelp" required placeholder="Enter username">
	  </div>
	  <div class="form-group" >
