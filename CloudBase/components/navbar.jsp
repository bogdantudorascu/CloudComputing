<nav class="navbar navbar-inverse">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="/CloudBase/">CloudBase</a>
      </div>
      ...
      <% if (session.getAttribute("username") == null) { %>
	   ...
	   <a href="/CloudBase/SignUp" class="btn btn-primary">Sign up</a>
        </form>
       <% } else {%>
       ...
       <form action="SignOut" method="POST" class="navbar-form navbar-right">
        ...
        <a href="/CloudBase/Profile" class="btn btn-primary">Profile</a>
       </div>
